...
22. [-] Reader [50%]
    ...
    7. [ ] [[./haskell_programming_from_first_principles/22_07.hs][The Monad of Functions]]
    8. [ ] Reader Monad by itself is kinda boring
    9. [ ] You can change what comes below, but not above
    10. [ ] You tend to see ReaderT, not Reader
    11. [ ] [[./haskell_programming_from_first_principles/22_11.hs][Chapter Exercises]]
    12. [ ] Follow-up Resources
23. [-] State [55%]
    1. [X] State
    2. [X] What is State?
    3. [X] Random Numbers
    ...
    6. [ ] [[./haskell_programming_from_first_principles/23_06.hs][Write State for yourself]]
    7. [ ] Get a Coding Job with this one weird trick
    8. [ ] Chapter Exercises
    9. [ ] Follow-up Resources
24. [-] Parser combinators [42%]
    ...
    4. [ ] [[./haskell_programming_from_first_principles/24_04.hs][Parsing fractions]]
    5. [ ] Haskell’s parsing ecosystem
    6. [ ] Alternative
    7. [ ] Parsing configuration files
25. [-] Composing types [30%]
    1. [X] Composing types
    2. [X] Common functions as types
    3. [X] Two little functors sittin’ in a tree, L-I-F-T-I-N-G
    4. [ ] Twinplicative
    5. [ ] Twonad?
    6. [ ] Intermission:Exercises
