...
-- For these exercises, we’ll use the datatypes defined in the above section. It
-- would be good if you’d typed them all into a source file already, but if you
-- hadn’t please do so now. You can then define some sample data on your own, or
